...
<head>
	<meta charset="UTF-8">
	<title>湯先生 Mr.Spring - 發表討論區文章</title>
		            ...
		            <div class="chooseCard_d">
		                ...
		                <div class="lightbox_filter">
		            		...
		            		<select id="lightbox_filter_select">
		            			<option value="1">全部湯牌</option>
		            			<option value="2">自己製作</option>
		            			<option value="3">討論區收藏</option>
							</select>
<script>
...
?>
				...
				<div class="publish_r" id="publish_r">
					<form action="php/add_article.php" id="addArt">
						<input type="text" maxlength="10" name="article_title" placeholder="請輸入標題(上限十個字)">
						<textarea maxlength="250" placeholder="請輸入內容分享(上限250字)" name="article_text"></textarea>
						<input type="hidden" name="cardNO" id="cardNo">
					</form>
					<button id="addArtBtn" class="btn_l">發表文章</button> 
				</div>
			</div>
		</div>
	</div>
